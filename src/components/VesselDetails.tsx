...
import { Ship, Battery, Navigation, Clock, MapPin, CreditCard, X, AlertTriangle } from 'lucide-react';
...
const stripePromise = loadStripe('pk_test_51IOqNtHsw5wcdFbBgddIAIJIkUDc5z9MbSFSv9b4jDOzX2XVWRrUzkYncHjWUPghObLa3zKgq9uTsNPxKDrz4Tmu00CcHKLgWN');
          ...
          <div className="p-4 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <div className="text-xs text-gray-500 dark:text-gray-400 mb-2">Battery</div>
                <div className="h-1 w-full bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                  <motion.div 
                    ...
                    className={`h-full rounded-full ${
                      batteryVoltage > 12 ? 'bg-emerald-500 dark:bg-emerald-400' :
                      batteryVoltage > 11 ? 'bg-amber-500 dark:bg-amber-400' :
              ...
              >
                ...
                <div className="text-xs text-gray-500 dark:text-gray-400 mb-2">Knots</div>
                <div className="h-1 w-full bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                  <motion.div 
                    initial={{ width: 0 }}
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3 text-sm">
                <div>
                  <div className="text-gray-500 dark:text-gray-400 text-xs">Latitude</div>
                  <div className="font-medium text-gray-900 dark:text-white">
                    {fleet.lat.toFixed(4)}°
                  </div>
                </div>
                <div>
                  <div className="text-gray-500 dark:text-gray-400 text-xs">Longitude</div>
                  <div className="font-medium text-gray-900 dark:text-white">
                    {fleet.lng.toFixed(4)}°
                  </div>
                </div>
